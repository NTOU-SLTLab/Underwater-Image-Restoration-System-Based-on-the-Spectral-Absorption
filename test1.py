...
if __name__ == "__main__":
    ...
    parser.add_argument('--val_path', type = str, default = 'D:/11053022/20231127/Hierarchical/testimage1210', help = 'saving path that is a folder')
    ...
    # Dataset parameters
    parser.add_argument('--baseroot', type = str, default = 'D:/11053022/20231127/Hierarchical/NTIRE2020_Test_Clean', help = 'baseroot')
    ...
    # ----------------------------------------
    load_net_name_list = []
    load_net_name_list.append('D:/11053022/20231127/Hierarchical/track1/code1_320_G_epoch9000_bs4.pth')
    load_net_name_list.append('D:/11053022/20231127/Hierarchical/track1/code1_384_G_epoch6000_bs4.pth')
    load_net_name_list.append('D:/11053022/20231127/Hierarchical/track1/code1_bs2_G_epoch8000_bs2.pth')
    load_net_name_list.append('D:/11053022/20231127/Hierarchical./track1/code1_bs4_G_epoch9000_bs4.pth')
    load_net_name_list.append('D:/11053022/20231127/Hierarchical/track1/code1_first_G_epoch10000_bs8.pth')
    load_net_name_list.append('D:/11053022/20231127/Hierarchical/track1/code1_G_epoch9000_bs8.pth')
    load_net_name_list.append('D:/11053022/20231127/Hierarchical/track1/code1_second_G_epoch8000_bs8.pth')
    load_net_name_list.append('D:/11053022/20231127/Hierarchical/track1/code2_G_epoch7000_bs8.pth')
    ...
    for i, name in enumerate(load_net_name_list):
        if i < 7:
            ...
            for j, (img1, img2, path) in enumerate(test_loader):
                ...
                save_img_name = base_file_name + '.mat'  
